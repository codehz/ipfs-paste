...
declare module "https://cdn.skypack.dev/handlebars" {
  declare namespace Handlebars {
    ...
    export { parse, ParseOptions, parseWithoutProcessing };
...
**/
  ...
  export type HandlebarsTemplateDelegate<T = any> = Handlebars.TemplateDelegate<
    T
  >;
